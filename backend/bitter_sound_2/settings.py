"""
Django settings for bitter_sound_2 project.
...
ROOT_URLCONF = 'bitter_sound_2.urls'
...
WSGI_APPLICATION = 'bitter_sound_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Bitter Sound Support <support@bitter-sound-2.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_sound_2 API",
    "DESCRIPTION": "API documentation for bitter_sound_2 App",
    "VERSION": "v1",
}
